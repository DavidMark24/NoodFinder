                ...
                <motion.div key={cuisineIndex} animate={{ x: 0, opacity: 1 }} initial={{ x: 0, opacity: 0 }} exit={{ x: -600, opacity: 0 }} className="col-lg-5 col-m-7 col-sm-8 shadow-lg p-3 m-4 my-3 extra-rounded tan_bg">
                    ...
                    <div className="p-3">
                        ...
                        <div className="row text-center mt-4">
                            <div className="col-4">
                                <motion.img key={rejectButton} src={rejectButton} whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }}  onClick={e => changeCuisine(e)} width='100%' alt=""/>
                            </div>
                            <div className="col-4">
                                {/* Empty column */}
                            </div>
                            <div className="col-4">
                                <Link to = {`/location/${cuisines[cuisineIndex].name}`}>
                                    <motion.img key={acceptButton} src={acceptButton} whileHover={{ scale: 1.2 }} whileTap={{ scale: 0.8 }}  id={cuisines[cuisineIndex].id} width='100%' alt=""/>
                                </Link>
                            </div>
                        </div>
                    </div>
